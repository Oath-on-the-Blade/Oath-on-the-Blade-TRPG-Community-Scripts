...
- `HJ01-E3`：不可承接；`partly_completed`；玩家可見收束〈斷口留在水裡〉；階段正文宣讀後宣告「戰役部分完成（1/4）」
...
- `HJ02-E3`：倉內責任成立但全部去向來源永久失去；`night_route_known=false`；`partly_completed`；收束〈倉門內的一筆罪〉；階段正文宣讀後宣告「戰役部分完成（2/4）」
...
- `HJ03-E3`：貨物受控但所有末路來源永久失去；`partly_completed`；收束〈一船鐵停在岸上〉；階段正文宣讀後宣告「戰役部分完成（3/4）」
...
- `HJ04-E3`：只能交付部分核心；`three_links_proven=false`；`partly_completed`；收束〈三枚印只對上兩枚〉；階段正文宣讀後宣告「戰役部分完成（4/4）」
